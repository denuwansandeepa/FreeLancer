        ...
        {role === "FREELANCER" ? (
          <>
            <button
              ...
              className="rounded-2xl bg-white px-5 py-4 text-left font-bold text-gray-900 hover:bg-blue-50 cursor-pointer"
            >
              ➕ Add New Service
            </button>
            <button
              onClick={onViewAnalyticsClick}
              className="rounded-2xl bg-white/10 px-5 py-4 text-left font-bold text-white hover:bg-white/15 cursor-pointer"
            >
              📊 View Analytics
            </button>
          </>
